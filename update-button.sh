  ...
  return (
    <div className="flex flex-col h-screen bg-gray-50">
      ...
      {requirements.length > 0 && !projectStructure && !isGeneratingStructure && (
        <div className="fixed right-4 top-[400px] w-64">
          <button
      ...
      {projectStructure && (
        <div className="fixed right-4 top-[460px] w-96">
      ...
      {/* Loading State */}
      {isGeneratingStructure && (
        <div className="fixed right-4 top-[460px] w-96 bg-white rounded-lg shadow-lg border border-gray-200 p-4">
